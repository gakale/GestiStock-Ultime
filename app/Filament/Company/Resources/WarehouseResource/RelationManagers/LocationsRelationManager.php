...
namespace App\Filament\Company\Resources\WarehouseResource\RelationManagers;
...
class LocationsRelationManager extends RelationManager
{
    ...
    protected static ?string $label = 'emplacement';
    
    protected static ?string $pluralLabel = 'emplacements';
        ...
        return $table
            ...
            ->filters([
                ...
                Tables\Filters\TernaryFilter::make('is_active')
                    ...
                    ->trueLabel('Emplacements actifs')
                    ->falseLabel('Emplacements inactifs'),
            ])
            ->headerActions([
                Tables\Actions\CreateAction::make()
                    ->label('Nouvel emplacement')
                    ->mutateFormDataUsing(function (array $data): array {
                        // Préremplit automatiquement l'entrepôt avec l'entrepôt parent
